...
snapshot_tag <- variables$snapshot$tag
bids_version <- variables$bids$version
```
...
The raw MRI data are organized according to [`{r} bids_version`](`{r} glue("https://bids-specification.readthedocs.io/en/{bids_version}/")`) of the BIDS standard. 
...
The pressures that were applied during the CUFF scans are recorded in the [`sub-\[record_id\]_ses-\[ses_id\]_task-cuff_run-\[run_id\]_events.tsv` tables](`{r} glue("https://bids-specification.readthedocs.io/en/{bids_version}/modality-specific-files/task-events.html")`).

BIDS requires that the diffusion gradient information is stored according to the FSL format, in `*bval` and `*bvec` files in the `/dwi` directory. For details see: [Magnetic Resonance Imaging - Brain Imaging Data Structure](`{r} glue("https://bids-specification.readthedocs.io/en/{bids_version}/modality-specific-files/magnetic-resonance-imaging-data.html#required-gradient-orientation-information")`).
...
tribble(
  ~File                                                                                                                                                                                                   ,
  ~Documentation                                                                                                                                                                                          ,
  glue("README ([A2CPS file](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/README.md))")                                                                                        ,
  glue("[modality agnostic files](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html)")                                                                             ,
  glue("participants.tsv ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/participants.json))")                                                                      ,
  glue("[participants file](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#participants-file)")                                                                 ,
  glue("sub-\\[record_id\\]_ses-\\[ses_id\\]_scans.tsv tables ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/scans.json))")                                        ,
  glue("[scans file](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#scans-file)")                                                                               ,
  glue("sub-\\[record_id\\]_sessions.tsv tables ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/sessions.json))")                                                   ,
  glue("[sessions file](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#sessions-file)")                                                                         ,
  glue("sub-\\[record_id\\]_ses-\\[ses_id\\]_task-cuff_run-\\[run_id\\]_events.tsv tables ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/task-cuff_events.json))") ,
  glue("[task events](https://bids-specification.readthedocs.io/en/{bids_version}/modality-specific-files/task-events.html)")                                                                             ,
  glue("dataset_description.json ([A2CPS file](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/dataset_description.json))")                                                       ,
  glue("[dataset descriptions](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#dataset_descriptionjson)")
)
```
