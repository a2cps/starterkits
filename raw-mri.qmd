...
tibble::tribble(
  ...
  ~Documentation,
  glue::glue(
    "README ([A2CPS file](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/README.md))"
  ),
  glue::glue(
    "[modality agnostic files](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html)"
  ),
  glue::glue(
    "participants.tsv ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/participants.json))"
  ),
  glue::glue(
    "[participants file](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#participants-file)"
  ),
  glue::glue(
    "sub-[record_id]_ses-[ses_id]_scans.tsv tables ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/scans.json))"
  ),
  glue::glue(
    "[scans file](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#scans-file)"
  ),
  glue::glue(
    "sub-[record_id]_sessions.tsv tables ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/sessions.json))"
  ),
  glue::glue(
    "[sessions file](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#sessions-file)"
  ),
  glue::glue(
    "sub-[record_id]_ses-[ses_id]_task-cuff_run-[run_id]_events.tsv tables ([dictionary](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/task-cuff_events.json))"
  ),
  glue::glue(
    "[task events](https://bids-specification.readthedocs.io/en/{bids_version}/modality-specific-files/task-events.html)"
  ),
  glue::glue(
    "dataset_description.json ([A2CPS file](https://github.com/a2cps/snapshot/blob/{snapshot_tag}/src/snapshot/data/dataset_description.json))"
  ),
  glue::glue(
    "[dataset descriptions](https://bids-specification.readthedocs.io/en/{bids_version}/modality-agnostic-files.html#dataset_descriptionjson)"
  )
)
```
