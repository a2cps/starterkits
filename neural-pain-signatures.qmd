# Neural Pain Signatures (Primary task fMRI biomarkers)

## Before Proposing Project

### Confirm Sample Size

Not all participants in a release have imaging, and not all MRIs are of good quality. Before proposing a project, please confirm that a release will have a large enough sample size. Release 1.1 has 440 participants with the primary task fMRI biomarkers ([NPS](https://doi.org/10.1056/NEJMoa1204471) and [SIIPS-1](https://doi.org/10.1038/ncomms14211)).
...
Each of the folders contain a table of values, and `*.json` sidecars are [data dictionaries that conform to BIDS ](https://bids-specification.readthedocs.io/en/v1.9.0/common-principles.html#tabular-files).
...
The signature responses were extracted using best-practices, but the imaging DIRC is currently exploring alternative ways of calculating signature responses in the CUFF tasks. For details and progress, please see https://a2cps.atlassian.net/wiki/spaces/DOC/pages/5406923/Imaging+Analysis+Ideas#NPS%2BSIIPS1-on-ToPS-or-SpaceTop-Data.
