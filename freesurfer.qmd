...
- aparc.tsv 
  - measurements derived from parcellations of the cortical surface, like cortical thickness
  - produced by [`aparcstats2table`](https://surfer.nmr.mgh.harvard.edu/fswiki/aparcstats2table)
- aseg.tsv 
  - measurements derived from segmentations of the 3d structural image, like regional gray matter volumes
...
In this kit, we will explore the cortical surface measurements, stored within `aparc.tsv`. This table contains nine regional measurements for the various structures that compose each of six parcellations.
